  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-6">
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-4">
        <Link href="/about" className="px-8 py-3 bg-blue-500 text-white font-semibold rounded-full shadow-md transition duration-300 hover:bg-blue-600 hover:shadow-lg focus:ring-4 focus:ring-blue-300 transform hover:scale-105 text-center">
          Learn more about us
        </Link>
        <Link href="/contact" className="px-8 py-3 bg-purple-500 text-white font-semibold rounded-full shadow-md transition duration-300 hover:bg-purple-600 hover:shadow-lg focus:ring-4 focus:ring-purple-300 transform hover:scale-105 text-center">
          Contact us
        </Link>
      </div>
    </div>
